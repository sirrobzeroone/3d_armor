...
if minetest.global_exists("armor") and armor.elements then
	...
	armor.config.level_multiplier = mult * 1
end
...
armor:register_armor("shields:shield_admin", {
	...
	groups = {armor_shield=1000, armor_heal=100, armor_use=0, not_in_creative_inventory=1, armor_m_admin=1},
})
...
if armor.materials.wood then
	armor:register_armor("shields:shield_wood", {
		...
		groups = {armor_shield=1, armor_heal=0, armor_use=2000, flammable=1, armor_m_wood=1},
	...
	armor:register_armor("shields:shield_enhanced_wood", {
		...
		groups = {armor_shield=1, armor_heal=0, armor_use=2000, armor_m_wood=1},
...
if armor.materials.cactus then
	armor:register_armor("shields:shield_cactus", {
		...
		groups = {armor_shield=1, armor_heal=0, armor_use=1000, armor_m_cactus=1},
		armor_groups = {fleshy=5},
...
if armor.materials.steel then
	armor:register_armor("shields:shield_steel", {
		...
		groups = {armor_shield=1, armor_heal=0, armor_use=800, armor_m_steel=1, physics_speed=-0.03, physics_gravity=0.03},
...
if armor.materials.bronze then
	armor:register_armor("shields:shield_bronze", {
		...
		groups = {armor_shield=1, armor_heal=6, armor_use=400, armor_m_bronze=1, physics_speed=-0.03, physics_gravity=0.03},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
		reciprocate_damage = true,
		on_damage = function(player, index, stack)
...
if armor.materials.diamond then
	armor:register_armor("shields:shield_diamond", {
		...
		groups = {armor_shield=1, armor_heal=12, armor_use=200, armor_m_diamond=1},
...
if armor.materials.gold then
	armor:register_armor("shields:shield_gold", {
		...
		groups = {armor_shield=1, armor_heal=6, armor_use=300, armor_m_gold=1, physics_speed=-0.04, physics_gravity=0.04},
		armor_groups = {fleshy=10},
...
if armor.materials.mithril then
	armor:register_armor("shields:shield_mithril", {
		...
		groups = {armor_shield=1, armor_heal=12, armor_use=100, armor_m_mithril=1},
		armor_groups = {fleshy=15},
...
if armor.materials.crystal then
	armor:register_armor("shields:shield_crystal", {
		...
		groups = {armor_shield=1, armor_heal=12, armor_use=100, armor_fire=1, armor_m_crystal=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=1, level=3},
		reciprocate_damage = true,
		on_damage = function(player, index, stack)
