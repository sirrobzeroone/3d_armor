...
armor:register_armor("3d_armor:helmet_admin", {
	...
	groups = {armor_head=1, armor_heal=100, armor_use=0, armor_water=1, armor_m_admin=1,
...
armor:register_armor("3d_armor:chestplate_admin", {
	...
	armor_groups = {fleshy=100},
	groups = {armor_torso=1, armor_heal=100, armor_use=0, armor_m_admin=1,
			not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
...
armor:register_armor("3d_armor:leggings_admin", {
	...
	armor_groups = {fleshy=100},
	groups = {armor_legs=1, armor_heal=100, armor_use=0, armor_m_admin=1,
			not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
...
armor:register_armor("3d_armor:boots_admin", {
	...
	armor_groups = {fleshy=100},
	groups = {armor_feet=1, armor_heal=100, armor_use=0, armor_m_admin=1,
			not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
...
if armor.materials.wood then
	armor:register_armor("3d_armor:helmet_wood", {
		...
		groups = {armor_head=1, armor_heal=0, armor_use=2000, flammable=1, armor_m_wood=1},
	...
	armor:register_armor("3d_armor:chestplate_wood", {
		...
		groups = {armor_torso=1, armor_heal=0, armor_use=2000, flammable=1, armor_m_wood=1},
	...
	armor:register_armor("3d_armor:leggings_wood", {
		...
		groups = {armor_legs=1, armor_heal=0, armor_use=2000, flammable=1, armor_m_wood=1},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:boots_wood", {
		...
		groups = {armor_feet=1, armor_heal=0, armor_use=2000, flammable=1, armor_m_wood=1},
		armor_groups = {fleshy=5},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
...
if armor.materials.cactus then
	armor:register_armor("3d_armor:helmet_cactus", {
		...
		groups = {armor_head=1, armor_heal=0, armor_use=1000, armor_m_cactus=1},
		armor_groups = {fleshy=5},
	...
	armor:register_armor("3d_armor:chestplate_cactus", {
		...
		groups = {armor_torso=1, armor_heal=0, armor_use=1000, armor_m_cactus=1},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=3, snappy=3, choppy=2, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:leggings_cactus", {
		...
		groups = {armor_legs=1, armor_heal=0, armor_use=1000, armor_m_cactus=1},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=3, snappy=3, choppy=2, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:boots_cactus", {
		...
		groups = {armor_feet=1, armor_heal=0, armor_use=1000, armor_m_cactus=1},
		armor_groups = {fleshy=5},
		damage_groups = {cracky=3, snappy=3, choppy=2, crumbly=2, level=1},
	})
...
if armor.materials.steel then
	armor:register_armor("3d_armor:helmet_steel", {
		...
		groups = {armor_head=1, armor_heal=0, armor_use=800,
			physics_speed=-0.01, physics_gravity=0.01, armor_m_steel=1},
		armor_groups = {fleshy=10},
	...
	armor:register_armor("3d_armor:chestplate_steel", {
		...
		groups = {armor_torso=1, armor_heal=0, armor_use=800,
			physics_speed=-0.04, physics_gravity=0.04, armor_m_steel=1},
	...
	armor:register_armor("3d_armor:leggings_steel", {
		...
		groups = {armor_legs=1, armor_heal=0, armor_use=800,
			physics_speed=-0.03, physics_gravity=0.03, armor_m_steel=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
	})
...
if armor.materials.bronze then
	...
	armor:register_armor("3d_armor:chestplate_bronze", {
		...
		armor_groups = {fleshy=15},
		damage_groups = {cracky=3, snappy=2, choppy=2, crumbly=1, level=2, armor_m_bronze=1},
	})
...
if armor.materials.diamond then
	armor:register_armor("3d_armor:helmet_diamond", {
		...
		groups = {armor_head=1, armor_heal=12, armor_use=200, armor_m_diamond=1},
		armor_groups = {fleshy=15},
	...
	armor:register_armor("3d_armor:chestplate_diamond", {
		...
		groups = {armor_torso=1, armor_heal=12, armor_use=200, armor_m_diamond=1},
	...
	armor:register_armor("3d_armor:leggings_diamond", {
		...
		groups = {armor_legs=1, armor_heal=12, armor_use=200, armor_m_diamond=1},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:boots_diamond", {
		...
		groups = {armor_feet=1, armor_heal=12, armor_use=200, armor_m_diamond=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
end
...
if armor.materials.gold then
	armor:register_armor("3d_armor:helmet_gold", {
		...
		groups = {armor_head=1, armor_heal=6, armor_use=300,
			physics_speed=-0.02, physics_gravity=0.02, armor_m_gold=1},
		armor_groups = {fleshy=10},
	...
	armor:register_armor("3d_armor:chestplate_gold", {
		...
		groups = {armor_torso=1, armor_heal=6, armor_use=300,
			physics_speed=-0.05, physics_gravity=0.05, armor_m_gold=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=1, snappy=2, choppy=2, crumbly=3, level=2},
	})
	armor:register_armor("3d_armor:leggings_gold", {
		...
		groups = {armor_legs=1, armor_heal=6, armor_use=300,
			physics_speed=-0.04, physics_gravity=0.04, armor_m_gold=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=1, snappy=2, choppy=2, crumbly=3, level=2},
	})
...
if armor.materials.mithril then
	armor:register_armor("3d_armor:helmet_mithril", {
		...
		groups = {armor_head=1, armor_heal=12, armor_use=100, armor_m_mithril=1},
		armor_groups = {fleshy=15},
	...
	armor:register_armor("3d_armor:chestplate_mithril", {
		...
		groups = {armor_torso=1, armor_heal=12, armor_use=100, armor_m_mithril=1},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	armor:register_armor("3d_armor:leggings_mithril", {
		...
		groups = {armor_legs=1, armor_heal=12, armor_use=100, armor_m_mithril=1},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	armor:register_armor("3d_armor:boots_mithril", {
		...
		groups = {armor_feet=1, armor_heal=12, armor_use=100, armor_m_mithril=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
end
...
if armor.materials.crystal then
	armor:register_armor("3d_armor:helmet_crystal", {
		...
		groups = {armor_head=1, armor_heal=12, armor_use=100, armor_fire=1, armor_m_crystal=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	armor:register_armor("3d_armor:chestplate_crystal", {
		...
		groups = {armor_torso=1, armor_heal=12, armor_use=100, armor_fire=1, armor_m_crystal=1},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	armor:register_armor("3d_armor:leggings_crystal", {
		...
		groups = {armor_legs=1, armor_heal=12, armor_use=100, armor_fire=1, armor_m_crystal=1},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	armor:register_armor("3d_armor:boots_crystal", {
		...
		groups = {armor_feet=1, armor_heal=12, armor_use=100, physics_speed=1,
				physics_jump=0.5, armor_fire=1, armor_m_crystal=1},
		armor_groups = {fleshy=15},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
end
